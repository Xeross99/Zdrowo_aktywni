...
const navigation = [
  ...
  },
  {
    ...
    icon: (props) => (
      <svg xmlns="http://www.w3.org/2000/svg" height="21" fill="currentColor" viewBox="0 0 19 19" {...props}>
  ...
  },
  {
    ...
    icon: (props) => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18" {...props}>
    ...
    <footer className="bg-white overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center space-x-6 md:order-2">
          {navigation.map((item) => (
            <a key={item.name} href={item.href} target='_blank' rel="noreferrer" className="text-gray-400 hover:text-gray-500 cursor-pointer">
        ...
        <div className="mt-8 md:order-1 md:mt-0 relative">
          ...
          <p className="text-center text-xs leading-5 text-gray-500">
            Created by <a href='https://github.com/Xeross99' target='_blank' rel="noreferrer" className='hover:underline'>Michał Krzysteczko</a>
          </p>
