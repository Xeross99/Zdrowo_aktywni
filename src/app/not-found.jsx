export default function notFound() {
  return (
    <main className="mx-auto flex w-full max-w-7xl flex-auto flex-col justify-center px-6 py-24 sm:py-64 lg:px-8">
      <p className="text-base/8 font-semibold text-green-600">404</p>
      ...
      <div className="mt-10">
        <a href="/" className="text-sm/7 font-semibold text-green-600"><span aria-hidden="true">&larr;</span> Wróć do strony głównej</a>
      </div>
    </main>
  )
}
